...
Or if you don't like following tutorials and just want to play with the code, here's a note for you...The hashtag to search by and number of tweets to favourited, can be set by adjusting the 'q' and 'count' parameters in the app.js file.
